               ...
               <div class="col-xl-9 mx-auto">
                  <div class="form-wrap2" name="" action="">
                     ...
                     <div class="gray-line">
                        <p style="font-size: 1.0em; color: black;">
                        <div class="gray-line2">
                           <br> <strong><h5>&nbsp;&nbsp;◆ 어떤 로스팅 정도를  선호합니까?</strong> <img class="reco-img"
                              src="./Resources/assets/img/roasting.png" alt="..." />
                           </h5>
                           <br>
                        </div>
                        <br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info2" value="미디움로스팅">미디움 로스팅 : 연한 아메리카노 정도입니다.<br>
                        &nbsp;&nbsp;<input type="radio" name="chk_info2" value="시티로스팅">시티 로스팅 : 가장 표준적인 로스팅 정도입니다.<br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info2" value="풀시티로스팅">풀 시티 로스팅 :산미보다 쓴맛이 강하고 고소한 맛이 특징입니다.<br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info2" value="하이로스팅">하이 로스팅: 쓴맛이 특징입니다.
                        </p>
                     </div>
                     <br>
                     ...
                     <div class="gray-line">
                        ...
                        <div class="gray-line2">
                           <br> <strong><h5>
                           &nbsp;&nbsp;◆ 어떤 산미 정도를 선호합니까?</strong> <img class="reco-img" src="./Resources/assets/img/sour.png" alt="..." /> (1 - 약함 5
                           - 강함)
                           </h5>
                           <br>
                        </div>
                        <br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info3" value="1">1<br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info3" value="2">2<br> 
                        &nbsp;&nbsp;<input type="radio" name="chk_info3" value="3">3<br>
