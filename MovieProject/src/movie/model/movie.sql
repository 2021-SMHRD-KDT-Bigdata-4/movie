...
select * from tbl_admin;
  select  movie_seq,movie_picture,movie_country,movie_title,movie_genre,movie_summary,movie_director,movie_rate,movie_actor,movie_video,movie_price,movie_runtime,movie_producer,movie_sdate,movie_sumaudience,movie_age,admin_id   from tbl_movie where movie_genre='액션';
...
'5백만', '15','admin');
 ...
 select * from ( select movie_seq as row_num, tbl_movie.* from tbl_movie)  where row_num <=10;
   select  movie_seq,movie_picture,movie_country,movie_title,movie_genre,movie_summary,movie_director,movie_rate,movie_actor,movie_video,movie_price,movie_runtime,movie_producer,movie_sdate,movie_sumaudience,movie_age,admin_id  
    	   from tbl_movie where movie_genre ='코미디' 
    	   select  * from tbl_movie where movie_title = '명량'